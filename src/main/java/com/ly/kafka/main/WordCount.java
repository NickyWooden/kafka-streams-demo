...
public class WordCount {
    static final String inputTopic = "t_top";
    static final String outputTopic = "t_n_top";

    /**
     * The Streams application as a whole can be launched like any normal Java application that has a `main()` method.
     */
    public static void main(final String[] args) {
        final String bootstrapServers = args.length > 0 ? args[0] : "192.168.1.107:9092";
    ...
    static Properties getStreamsConfiguration(final String bootstrapServers) {
        ...
        streamsConfiguration.put(StreamsConfig.STATE_DIR_CONFIG, "D:/temp");
    ...
    static void createWordCountStream(final StreamsBuilder builder) {
        ...
        final KTable<String, Long> wordCounts = textLines
                ...
                .count();
        wordCounts.toStream().foreach((k,v) ->System.out.println("k,v: "+k+","+v));
